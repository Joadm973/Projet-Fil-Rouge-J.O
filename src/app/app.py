...
from src.app.views import athletes, annotations, exploration, generations, home, multisource, predictions
...
PAGES = {
    ...
    "🌱  Nouvelles générations": "generations",
    "🌐  Multi-sources": "multisource",
}
